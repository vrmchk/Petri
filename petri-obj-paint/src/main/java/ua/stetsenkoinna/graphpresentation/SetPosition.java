...
public class SetPosition extends javax.swing.JFrame {
    ...
    public SetPosition(PetriNetsPanel panel) {
        ...
        this.panel = panel;
        this.setSize(new Dimension(320, 275));
    }
    ...
    private void initComponents() {
        ...
        jobMarkersCheckbox = new javax.swing.JCheckBox("Job markers"); // Added checkbox
        isFinalCheckbox = new javax.swing.JCheckBox("Is final place"); // Added checkbox
        isJobQueue = new javax.swing.JCheckBox("Is job queue"); // Added checkbox
                ...
                setPositionPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(setPositionPanelLayout.createSequentialGroup()
                                ...
                                .addGroup(setPositionPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(jobMarkersCheckbox) // Added checkbox here
                                        .addComponent(isFinalCheckbox) // Added checkbox here
                                        .addComponent(isJobQueue)) // Added checkbox here
        ...
        setPositionPanelLayout.setVerticalGroup(
                setPositionPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(setPositionPanelLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jobMarkersCheckbox) // Positioned below the mark text field
                                .addComponent(isFinalCheckbox) // Positioned below the mark text field
                                .addComponent(isJobQueue) // Positioned below the mark text field
                                .addContainerGap())
        );
    ...
    private void setPMark() { // modified by Katya 08.12.2016
        ...
        if (Utils.tryParseInt(markValueStr)) {
            petriPlace.setMark(Integer.valueOf(markValueStr), jobMarkersCheckbox.isSelected(), isFinalCheckbox.isSelected(), isJobQueue.isSelected());
            petriPlace.setMarkParam(null);
        } else {
            petriPlace.setMarkParam(markValueStr);
        }

        jobMarkersCheckbox.setSelected(false);
        isFinalCheckbox.setSelected(false);
        isJobQueue.setSelected(false);
    }
    ...
    private javax.swing.JCheckBox jobMarkersCheckbox; // Checkbox declaration
    private javax.swing.JCheckBox isFinalCheckbox; // Checkbox declaration
    private javax.swing.JCheckBox isJobQueue; // Checkbox declaration
